<template>
    <div class="pb-4">
        <div class="postImg mb-2 ">
            <v-img
                src="https://images.unsplash.com/photo-1558980394-4c7c9299fe96?ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80"
                alt="user" aspect-ratio="1.4" height="200"></v-img>
            <div class="postCategory font-weight-bold mx-3">سياحه</div>
        </div>
        <v-container fluid>
